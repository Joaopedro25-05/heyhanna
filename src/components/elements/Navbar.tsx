...
export const Navbar = () => {
  const { trocarTema, tema } = useThemeStore();
  return (
        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="min-w-max inline-flex relative">
            <a href="/" className="relative flex items-center gap-3">
              <img src={logo} alt="Hey Hanna Logo" className="w-10 h-10" />
          ...
          >
            ...
            <div className="lg:min-w-max flex items-center sm:w-max w-full pb-6 lg:pb-0 border-box-border lb:border-0 px-6 lg:px-0">
              <BtnLink text="Cadastrar" href="#cta" className="" />
              <BtnLink text="Entrar" href="#cta" className="m-2" />
            </div>
          </div>
